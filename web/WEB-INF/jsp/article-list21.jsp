...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 成绩统计分析 <span class="c-gray en">&gt;</span> 成绩统计 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${requestScope.listsc}" var="listsc">
				<tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td>${listsc.stuid}</td>
					<td>${listsc.scid}</td>
					<td>${listsc.language}</td>
					<td>${listsc.math}</td>
					<td>${listsc.english}</td>
					<td>${listsc.physics}</td>
					<td>${listsc.chemistry}</td>
					<td>${listsc.total}</td>
