...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<input type="hidden" value="${coueseinfo.kid}" name="kid">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">星期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="articletitle2" name="kzhou" value="${coueseinfo.kzhou}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">课程：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="articletitle2" name="kecheng" value="${coueseinfo.kecheng}">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="updatecouese()" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i>添加</button>
			</div>
		</div>
	</form>
</article>
...
function updatecouese() {
	 var form = document.forms[0];
	 form.action = "${pageContext.request.contextPath}/updatecouese";
	 form.method = "post";
     form.submit();
}
</script>
