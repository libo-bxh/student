	...
	<input type="hidden" name="stuid" value="${stuinfo.stuid }"/>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${stuinfo.stuxh}" placeholder="" id="" name="stuxh">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${stuinfo.stupwd}" placeholder="" id="" name="stupwd">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${stuinfo.stuname}" placeholder="" id="" name="stuname">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="stusex" class="select">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="请输入电话" id="" name="stutel" value="${stuinfo.stutel}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">QQ：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="" id="" name="stuqq" value="${stuinfo.stuqq}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="" id="" name="stuclass" value="${stuinfo.stuclass}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">年级：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="" id="" name="stugrade" value="${stuinfo.stugrade}">
			</div>
		</div>
		
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="updatestu();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
...
function updatestu() {
	...
	form.action = "${pageContext.request.contextPath }/updatestu"; 
	form.method = "post"; 
	form.submit();
}
...
function addstu() {
	 var form = document.forms[0];
	 form.action = "${pageContext.request.contextPath }/addstu";
	 form.method = "post";
     form.submit();
}
