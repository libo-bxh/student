...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加学生','picture-add2.jsp')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加学生</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			<c:forEach items="${requestScope.stuinfo}" var="stuinfo">
				<tr class="text-c">
					<td><input name="" type="checkbox" value=""></td>
					<td>${stuinfo.stuid}</td>
					<td>${stuinfo.stuxh}</td>
					<td>${stuinfo.stupwd}</td>
					<td>${stuinfo.stuname}</td>
					<td>${stuinfo.stusex}</td>
					<td>${stuinfo.stutel}</td>
					<td>${stuinfo.stuqq}</td>
					<td class="text-l">${stuinfo.stuclass}</td>
					<td class="text-c">${stuinfo.stugrade}</td>
					...
					<td class="td-manage"><a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
					 <a style="text-decoration:none" class="ml-5"  href="${pageContext.request.contextPath }/edit?stuid=${stuinfo.stuid}" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a> 
					 <a href="${pageContext.request.contextPath }/deleteid?stuid=${stuinfo.stuid}" style="text-decoration:none" class="ml-5" href="javascript:;" title="删除" onclick="return confirm('您确定删除?')"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
					</c:forEach>
			</tbody>
		</table>
