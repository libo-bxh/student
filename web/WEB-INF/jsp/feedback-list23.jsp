...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 班级通讯录 <span class="c-gray en">&gt;</span> 学生列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 查询个人信息：
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><a href="javascript:;" 
					       onclick="member_show('${list.stuname}','${pageContext.request.contextPath }/umail?stuid=${list.stuid }')">
					       <i class="avatar size-L radius">
					       <img alt="" src="static/h-ui/images/ucnter/avatar-default-S.gif">
					       </i>
					       </a>
					</td>
					<td>${list.stuxh}</td>
