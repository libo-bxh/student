...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 教学管理管理 <span class="c-gray en">&gt;</span> 登记成绩 </nav>
...
<!-- 	<div class="text-c">
	 日期范围：
		...
		<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i>搜一搜</button>
	</div> -->
	<!-- <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius" data-title="添加考试" data-href="article-add.html" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>登记成绩</a></span></div>
	 --> <div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c" >
					...
					<td>${score.total}</td>
					<td><a href="${pageContext.request.contextPath }/scoreup?scid=${score.scid}">登记成绩</a></td>				
				</tr>
	</c:forEach>
			</tbody>
		</table>
