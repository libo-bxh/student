...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">学生</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">.</a> 
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a 
						    onclick="picture_add('个人信息','stuinfoAll?stuid=${sessionScope.aid}')" href="javascript:;"
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 成绩查询<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>

					<li><a data-href="scoreAll" data-title="成绩查询" href="javascript:void(0)">成绩查询</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
			<dt><i class="Hui-iconfont">&#xe613;</i> 个人信息修改<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="stuinfoAll?stuid=${sessionScope.aid}" data-title="修改个人信息" href="javascript:void(0)">修改个人信息</a></li>
			</ul>
		</dd>
	</dl>
		
		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe622;</i> 班级通讯录<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/mail" data-title="班级信息" href="javascript:void(0)">学生列表</a></li>
