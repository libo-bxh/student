...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 成绩统计分析 <span class="c-gray en">&gt;</span> 年纪信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<c:forEach items="${requestScope.gradelist}" var="gradelist">
				<tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td>${gradelist.gaid}</td>
					<td>${gradelist.ganame}</td>
					<td>${gradelist.gaclass}</td>
					<td class="f-14 td-manage">
						<a style="text-decoration:none" 
							href="feedback-add1.jsp" title="添加"><i class="Hui-iconfont">&#xe6de;</i></a> 
							<a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','article-add.html','10001')" 
							href="${pageContext.request.contextPath}/getgradebyid?gaid=${gradelist.gaid}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
							<a style="text-decoration:none" class="ml-5" onClick="article_del(this,'10001')" 
							href="${pageContext.request.contextPath}/deletegrade?gaid=${gradelist.gaid}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
						</td>
				</tr>
				</c:forEach>
			</tbody>
